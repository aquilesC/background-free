...
\begin{document}
\maketitle \abstract{Metallic nanoparticles have opened the possibility of time
unlimited imaging, tracking and manipulation of biological samples. Their low
quantum yield however, makes them hard to detect under high background
...
it does not require major changes in existing setups, only the addition of an
...
brightness of gold nanoparticles is comparable to that of fluorescent molecules.
...
obtained in the case of labelling of organelles or the entire cell membrane.
...
photo stability and high quantum yield.
...
\ref{fig:power_intensity}a, but for a particle under cells that contained \atto.
In this case the background prevented the acquisition of luminescence spectra;
the particle for the Figure is representative of the average behavior. It can
readily be seen that in the Stokes case the particle's signal is negligibly
...
signal-to-background ratio of more than $20$. The background level observed in
...
higher than in the case without dye. This is given by selecting particles with a
...
too high. The correct focusing on the sample plane was verified both by
...
higher than for the Stokes emission. In the case of HeLa cells not containing a
