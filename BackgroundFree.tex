...
unlimited imaging, tracking and manipulating of biological samples. Their low
quantum yield however, makes them hard to detect in high background conditions.
In this work we show that it is possible to image gold nanorods by detecting
their anti-Stokes emission under resonant excitation. We show that even in a
cell stained with \atto, the signal-to-background ratio of the anti-Stokes
emission is higher than 10, while it is impossible to image the particles with
the Stokes emission. The main advantage of this technique is that it doesn't
require changes in existing setups, but the addition of an appropriate
