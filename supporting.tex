...
viability test. The black square represents the imaged area.}
	\label{fig:viability}
\end{figure}
...
rightmost is the result of staining the cells with XXX. The black square
represents the area that was imaged with the confocal microscope. The cells show
no change between before and after the procedure. Moreover there is no change in
the viability results of the cells that were irradiated with the laser and those
who were not.
...
detail mainly because of the poor signal-to-background ratio in the normal
